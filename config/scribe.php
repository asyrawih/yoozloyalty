    ...
    'routes' => [
        [
            ...
            'exclude' => [
                ...
                'api/campaign/auth/password/reset/validate-token',
                'api/campaign/auth/password/update',
                'api/staff/auth/password/reset/validate-token',
                'api/staff/auth/password/update'
            ],
