...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@github.com:setspl/loyalty-system.git',
        'http_user'=> 'www',
        'composer_options' =>  'update --verbose --prefer-dist --no-interaction --optimize-autoloader --ignore-platform-req=php',
