<template>
    <v-card>
        ...
        <v-card-title>
            <span class="text-h5">Approved Subscription Plan</span>
        </v-card-title>
        ...
        <div v-if="content.is_confirm">
            ...
            <v-card-text>
                <table class="my-3 body-1">
                    <tbody>
                        <tr
                            v-show="content.is_cheque || content.is_bank_transfer"
                        >
                            <td>Merchant Bank</td>
                            <td>:</td>
        ...
        const onOKClick = async () => {
            ...
            try {
                if (props.content && props.content.order_id) {
                    response = await ServicePlanOrders().approvedApi(props.content.order_id);
