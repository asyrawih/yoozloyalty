            ...
            <v-card-text>
                ...
                >
                    ...
                    <span v-else-if="form1.error === 'demo'"
                        ...
                        features, sign up with a new account.
                    </span>

                    <span v-else-if="form1.phone_personal === ''">
                        Phone number is empty, please enter phone number before continuing.
                    </span>

                    <!-- <span v-else-if="form1.phone_personal && form1.phone_personal.match(/^\d+$/) != true">
                        Phone number is invalid, please enter a valid phone number before continuing.
                    </span> -->
                ...
                >
                    <v-tab-item :value="'general'">
                        ...
                        <vue-tel-input-vuetify
                            mode="international"
                            v-model="form1.phone_personal"
                            :defaultCountry="form1.country_code"
                            :error-messages="errors.collect('form1.phone_personal')"
                        />
                    ...
                    <v-tab-item :value="'password'">
                        <v-text-field
                            ...
                            :error-messages="
                                errors.collect('form1.new_password')
                            "
...
export default {
    ...
    data() {
        return {
            ...
            form1: {
                ...
                phone_personal : this.$auth.user().phone_personal,
    ...
    created() {
        this.showDeleteAvatar = _.startsWith(
