        ...
        <v-card>
            ...
            >
                <v-card-text>
                    ...
                    <p>
                        Import credit request sample download <a href="/sample/import-credit-request-sample.xlsx">here</a>.
                    </p>
                </v-card-text>
...
export default defineComponent({
    name: 'merchant-credit-request-import',
    setup(props, {root}) {
    ...
    methods: {
        ...
        async onSubmit() {
            ...
            try {
                ...
                const response = await ServiceCreditRequest().importApi(formData);
