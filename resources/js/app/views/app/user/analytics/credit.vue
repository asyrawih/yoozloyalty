    ...
    <div style="height: 100%">
        ...
        >
            ...
            <div class="text-xs-center">
                ...
                <div class="pb-4 mx-5">
                    <p class="subheading">
                        Earning analytics will show here when customers redeem
                        points.
                    </p>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        async downloadExcel() {
            const response = await axios.get('/user/analytics/earning/exports', { responseType: 'blob' });

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement("a");

            link.href = url;
            link.setAttribute('download', 'credit_histories.xlsx');
