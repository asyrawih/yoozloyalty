    ...
    <div style="height: 100%">
        ...
        >
            ...
            <div class="text-xs-center">
                ...
                <h1 class="my-4 title">There are no analytics available yet</h1>
                <div class="pb-4 mx-5">
                    <p class="subheading">
                        Spending analytics will show here when customers redeem
                        rewards.
                    </p>
                </div>
            </div>
        ...
        >
            ...
            <v-container fluid grid-list-xl>
                <v-layout row>
                    <v-flex xl12>
                        <v-card color="white">
                            <v-container fluid grid-list-xs class="px-3 py-0">
                                <v-layout row wrap>
                                    <v-flex xs12 md6 xl3>
                                        <v-autocomplete
                                            @change="changeFilter"
                        ...
                        <v-card color="white" class="mt-6">
                            <v-card-text
                                v-if="this.range.start !== this.range.end"
                            >
                                <GChart
                                    type="AreaChart"
                                    :data="chartData"
...
export default {
    ...
    methods: {
        ...
        async downloadExcel() {
            const response = await axios.get('/user/analytics/spending/exports', { responseType: 'blob' });

            const url = window.URL.createObjectURL(new Blob([response.data]));
            const link = document.createElement("a");

            link.href = url;
            link.setAttribute('download', 'reward_histories.xlsx');
