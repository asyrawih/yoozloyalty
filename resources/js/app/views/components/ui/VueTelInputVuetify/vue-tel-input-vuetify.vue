<template>
    <div :class="['vue-tel-input-vuetify', wrapperClasses]">
        ...
        <v-text-field
            ...
            :maxlength="maxLen"
            :tabindex="
                inputOptions && inputOptions.tabindex
        ...
        phone(newValue, oldValue) {
            if (newValue) {
                if (newValue[0] === "+") {
                    ...
                    if (code) {
                        this.activeCountry =
                            this.findCountry(code) || this.activeCountry;
                    }
                }
            }
    ...
    methods: {
        initializeCountry() {
            return new Promise(resolve => {
                 ...
                 */
                if (this.phone && this.phone[0] === "+") {
                    const activeCountry = PhoneNumber(
                        this.phone
                    ).getRegionCode();
                    if (activeCountry) {
                ...
                if (this.defaultCountry) {
                    const defaultCountry = this.findCountry(
                        this.defaultCountry
                    );
                    if (defaultCountry) {
