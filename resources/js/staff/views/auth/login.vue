                    ...
                    <v-card class="elevation-18 my-4">
                        ...
                        <v-card-text>
                            <v-alert
                                ...
                                class="mb-4"
                            >
                                <span v-if="form1.error_message === 'store_not_open'">{{ $t("store_not_open") }}</span>
                                <span v-else>{{ $t("login_not_recognized") }}</span>
                            </v-alert>
...
export default {
    ...
    created() {
        if (this.campaign.business.is_store_open === false) {
            this.form1.has_error = true;
            this.form1.error_message = 'store_not_open'
        }
    ...
    methods: {
        ...
        login(formName) {
            ...
            this.$auth.login({
                redirect: {
                    name: redirect ? redirect.from.name : "dashboard",
