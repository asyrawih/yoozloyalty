...
return [
    ...
    "customer_card" => "Membership Card Number",
    "give_card_to_merchant" => "Give this card number to the merchant.",
    "customer_card_info" => "Provide your customer card number so the merchant can redeem the reward.",
    "customer_card_points_info" => "Provide your customer card number so the merchant can add points.",
    "customer_otp_confirmation" => "Confirmation needed",
    "check_email_for_confirmation" => "Please check your email for confirmation code",
    ...
    "test_mail_head" => "Test Mail Service",
    "test_mail_button" => "Test Mail"
];
