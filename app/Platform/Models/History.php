...
class History extends Model
{
    ...
    protected $dates = ['points_expired_date'];
    ...
    /**
     * Parse the created_at attribute
     *
     * @return string
     */
    ...
    public function generateRedemptionId()
    {
        $number = mt_rand(1000000000, 9999999999);

        if ($this->redemptionIdExists($number)) {
            return $this->generateRedemptionId();
        }

        return $number;
    }

    public function redemptionIdExists($number)
    {
        // query the database and return a boolean
        // for instance, it might look like this in Laravel
        return $this->whereRedemptionId($number)->exists();
    }

    /**
     * Get Customer total redeem for today
     *
     * @return array
     */
    public function today_redeem_total()
    {
        return $this->whereDate('created_at', today())->count();
    }
}
