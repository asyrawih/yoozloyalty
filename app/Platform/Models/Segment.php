          ...
          'subs' => [
            'sub1' => [
              'items' => [
                ...
                ['type' => 'relation', 'relation' => ['type' => 'belongsToMany', 'permission' => 'personal', 'with' => 'businesses', 'remote_pk' => 'business_id', 'table' => 'businesses', 'pk' => 'id', 'val' => 'name', 'orderBy' => 'name', 'order' => 'asc'], 'text' => __('Store Name'), 'validate' => 'nullable'],
              ]
            ]
          ]
        ]
