 ...
 * @group Localization
 *
 * Endpoints related to localizations (translations, countries, cities)
 * @package Platform\Controllers\Core
 */
class Localization extends \App\Http\Controllers\Controller {
     ...
     * Get Countries
     *
     * @responseFile storage/responses/countries.get.json
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function getCountry()
    {
        $data = Country::select(['name as text', 'id as value'])->get();
     ...
     * Get Cities
     *
     * @responseFile storage/responses/cities.get.json
     *
     * @return \Illuminate\Http\JsonResponse
     */
    public function getCity()
    {
        $data = City::select(['name as text', 'id as value'])->get();
