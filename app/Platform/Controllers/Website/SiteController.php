...
class SiteController extends Controller {
  ...
  public function home() {
    ...
    $website = [
      ...
      'home' => [
        'title' => env('APP_TITLE', 'Loyalty Programs'),
      ],
      'features' => [
        "Create long lasting relationship with customers." => "Reward loyal customers.",
  ...
  public function getTerms() {
    ...
    $legal = SettingLegal::find(1);
    return view('website.terms', compact('account', 'company', 'legal'));
  }
}
